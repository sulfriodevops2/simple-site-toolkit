...
export const CATALOG: Record<Brand, Record<Orientation, Condenser[]>> = {
  samsung: {
    ...
    horizontal: [
      ...
      { nome: "Samsung VRF H 14HP", nominal: 133756, max: 145000 },
      { nome: "Samsung VRF H 16HP", nominal: 152864, max: 165000 },
      { nome: "Samsung VRF H 18HP", nominal: 171972, max: 185000 },
      { nome: "Samsung VRF H 20HP", nominal: 191080, max: 205000 },
    ],
  },
  daikin: {
    vertical: [
